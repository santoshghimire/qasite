...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'qasite.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///qasite'),
}
...
ACCOUNT_ADAPTER = 'qasite.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'qasite.users.adapters.SocialAccountAdapter'
